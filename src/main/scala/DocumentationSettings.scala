...
object DocumentationSettings extends sbt.Plugin {
  ...
  */
  ...
  lazy val genMarkdownDocsAndCommit = Command.command("genMarkdownDocsAndCommit") { st: State =>
    ...
    // TODO: clean the input docs dir
    extracted.runAggregated(Literator.generateDocs in ref, st)
    // TODO: move this commit to the end of release process
    // commitFiles("Autogenerated markdown documentation", extracted get Literator.docsOutputDirs)(newSt)
  }
